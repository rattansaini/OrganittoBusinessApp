          ...
          {!success ? (
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full py-3.5 bg-primary text-cream font-semibold rounded-xl shadow-soft hover:shadow-soft-lg transition-all duration-300 hover:scale-[1.02] active:scale-95"
              >
                Back to Login
              </button>
            </div>
